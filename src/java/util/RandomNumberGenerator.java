...
public class RandomNumberGenerator
{
    /**
     * A
     * <code>Random</code> Object instantiated by <code>java.security.SecureRandom</code>'s default constructor
     *
    ...
    /**
     * Static method that generates random alphanumeric <code>String</code> characters.
     *
     * @return concatenated alphanumeric <code>String</code> variable which has a variable length of characters.
    ...
    public static String generateRandomAlphanumericCharacters2(int length)
    {
        // Pick from some letters that won't be easily mistaken for each
        // other. So, for example, omit o O and 0, 1 l and L.
        String letters = "abcdefxyzABCDEJKMVWXYZ23456789";
